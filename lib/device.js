...
class Device extends EventEmitter {
  ...
  memoize (maxAge = 5000) {
    ...
    this.getSysInfo = memoize(this.getSysInfo, { promise: true, maxAge: maxAge, length: 0 });
    this.getModel = memoize(this.getModel, { promise: true, maxAge: maxAge, length: 0 }); // 10 min
  }
