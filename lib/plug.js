...
class Plug extends Device {
  ...
  memoize (maxAge = 5000) {
    ...
    this.getInUse = memoize(this.getInUse, { promise: true, maxAge: maxAge });
    this.getInfo = memoize(this.getInfo, { promise: true, maxAge: maxAge });
    this.getSysInfoAndConsumption = memoize(this.getSysInfoAndConsumption, { promise: true, maxAge: maxAge });
    this.getPowerState = memoize(this.getPowerState, { promise: true, maxAge: maxAge });
    this.getLedState = memoize(this.getLedState, { promise: true, maxAge: maxAge });
    this.getConsumption = memoize(this.getConsumption, { promise: true, maxAge: maxAge });
  }
